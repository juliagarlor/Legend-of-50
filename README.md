...
Help Billy fight against the terrific creatures living in this huge castle, so the new inhabitants can finally get to live here. It is a small game yet, but quite funny and addictive.
...
```
git clone https://github.com/juliagarlor/Legend-of-50.git
```
...
Please, make sure to check the lecture to develop this project in the following link: https://youtu.be/aE25rzLO-fo

Regarding to this legend-of-50 version, any feedback for improvement is welcome, and I hope you have fun using it.
